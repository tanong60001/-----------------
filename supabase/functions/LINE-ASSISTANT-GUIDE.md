...
- `line-attendance-report` รับ LINE webhook แสดงเมนู สร้าง PDF และดูแลลิงก์ดาวน์โหลด
...
## 6. ปิดงานอัตโนมัติที่ไม่จำเป็น

เพื่อประหยัดโควต้า LINE และ Edge Function:

- ปิด Database Webhook ที่ยิง `line-attendance-report` ทุกครั้งเมื่อเพิ่มข้อมูลเช็คชื่อ
...
1. แตะ `เช็คชื่อวันนี้` ต้องได้ลิงก์ PDF และรายชื่อพนักงานครบ
2. เปิดรอบลิ้นชัก แล้วแตะ `ยอดขายวันนี้` และ `จำนวนเงินในลิ้นชัก`
3. แตะ `ลูกค้าค้างชำระทั้งหมด` และตรวจยอดรวมกับหน้าโปรแกรม
4. แตะ `รายการขนส่ง` และตรวจบิลเกินกำหนด/ส่งวันนี้
5. แตะ `สินค้าขายดี 30 วัน` และตรวจอันดับกับบิลจริง
6. กดรายงานเดิมซ้ำภายใน 5 นาที การ์ดต้องระบุว่าใช้ไฟล์แคช
7. เปิดลิงก์ PDF หลัง 24 ชั่วโมง ต้องหมดอายุ ให้แตะกล่องเมนูเดิมเพื่อสร้างลิงก์ใหม่
