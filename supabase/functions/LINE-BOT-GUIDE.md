...
> **อัปเดต:** หากเปิดใช้เมนู “สวัดดีผู้ช่วย” ให้ใช้คู่มือ
> [`LINE-ASSISTANT-GUIDE.md`](./LINE-ASSISTANT-GUIDE.md) และตั้ง LINE Webhook URL ไปที่
> `line-attendance-report` แทน `line-webhook` ตามขั้นตอนในคู่มือใหม่
