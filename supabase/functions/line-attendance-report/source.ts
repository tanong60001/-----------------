...
function menuBubble() {
  ...
  const tiles = OPTIONS.map((option, index) => ({
    ...
    backgroundColor: styles[index].bg, cornerRadius: "20px", paddingAll: "14px",
    borderWidth: "1px", borderColor: styles[index].iconBg,
    action: {
    ...
    contents: [
      {
        ...
        backgroundColor: styles[index].iconBg, cornerRadius: "24px", alignItems: "center", justifyContent: "center",
      ...
      {
        type: "box", layout: "horizontal", margin: "sm", spacing: "xs", alignItems: "center",
        contents: [
  ...
  return {
    ...
    header: {
      type: "box", layout: "vertical", backgroundColor: "#FFF7F2",
      ...
      contents: [
        {
          ...
          contents: [
            {
              type: "box", layout: "vertical", width: "54px", height: "54px", backgroundColor: "#FFE4D6",
              cornerRadius: "27px", alignItems: "center", justifyContent: "center", flex: 0,
        ...
        {
          type: "box", layout: "horizontal", backgroundColor: "#FFFFFF", cornerRadius: "14px", paddingAll: "10px", spacing: "sm",
          contents: [
    ...
    body: { type: "box", layout: "vertical", paddingAll: "14px", spacing: "md",
      backgroundColor: "#FFFDFC", contents: rows },
    footer: { type: "box", layout: "vertical", paddingAll: "14px", spacing: "sm", backgroundColor: "#FFFFFF",
      contents: [
