...
(function v26CSS() {
  ...
  s.textContent = `
   /* ─── Header Banner (Premium Redesign) ─── */
    .v26-banner {
      background: linear-gradient(135deg, #15110d 0%, #241c12 50%, #655f3e 100%);
      border-radius: 28px; 
      padding: 32px; 
      margin-bottom: 32px;
      color: #ffffff;
    ...
    <div class="v26-banner">
      <div class="v26-banner-inner">
        <div class="v26-header-left">
          <h2>${randomEmoji} <div style="color: #fffffffa;">เช็คชื่อ<br>พนักงาน</div></h2>
          ...
          <div class="v26-stats-grid" id="v26-stats">
            ...
            <span class="v26-stat-pill">
              <span class="label-wrap"><i class="material-icons-round" style="font-size:16px;">hourglass_empty</i> ยังไม่ลง</span>
              <strong>${unc}</strong>
            </span>
          </div>
  ...
  wrap.innerHTML = `
    ...
    <div class="v26-pay-detail" style="cursor:default; margin-bottom:24px;">
      ...
      <div class="v26-pay-detail-body">
        ...
        ${myA.length > 0 ? `<div style="margin-top:14px;padding:12px 14px;background:#fffbeb;border-radius:10px;border:1.5px solid ;">
