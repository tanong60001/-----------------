(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      .v54-swal-popup{border-radius:26px!important;padding:0!important;overflow:hidden!important;background:#f8fafc!important;box-shadow:0 34px 90px rgba(15,23,42,.32)!important}
      ...
      .v54-swal-popup .swal2-actions{padding:0 28px 28px!important;margin:0!important;gap:12px!important}
      .v54-swal-popup .swal2-confirm,.v54-swal-popup .swal2-cancel{height:54px!important;border-radius:15px!important;font-weight:900!important;font-size:15px!important;padding:0 28px!important;box-shadow:none!important}
      .v54-swal-popup .swal2-confirm{background:linear-gradient(135deg,#ef4444,#dc2626)!important;box-shadow:0 14px 28px rgba(220,38,38,.24)!important}
      .v54-swal-popup .swal2-cancel{background:#64748b!important;color:#fff!important}
      .v54-quick-shell{text-align:left;margin:0;color:#0f172a}
      .v54-quick-top{position:relative;padding:28px 30px 24px;background:linear-gradient(135deg,#0f766e 0%,#14b8a6 46%,#f97316 100%);color:#fff;overflow:hidden}
      .v54-quick-top:before{content:'';position:absolute;right:-54px;top:-70px;width:180px;height:180px;border-radius:50%;background:rgba(255,255,255,.22)}
      .v54-quick-top:after{content:'';position:absolute;left:34px;bottom:-64px;width:150px;height:150px;border-radius:50%;background:rgba(255,255,255,.12)}
      .v54-quick-title{position:relative;display:flex;align-items:center;gap:14px}
      .v54-quick-title i{width:54px;height:54px;border-radius:17px;background:rgba(255,255,255,.18);display:flex;align-items:center;justify-content:center;box-shadow:inset 0 0 0 1px rgba(255,255,255,.28)}
      .v54-quick-title h2{margin:0;font-size:26px;line-height:1.1;color:#fff;font-weight:900;letter-spacing:0}
      .v54-quick-title p{margin:5px 0 0;color:rgba(255,255,255,.82);font-size:13px;line-height:1.45}
      .v54-quick-body{padding:24px 30px 18px;background:#fff}
      .v54-quick-note{display:grid;grid-template-columns:auto 1fr;gap:10px;align-items:start;padding:12px 13px;border:1px solid #fed7aa;background:#fff7ed;border-radius:14px;color:#9a3412;margin-bottom:16px}
      ...
      .v54-quick-total{margin-top:14px;padding:15px 16px;border:1px solid #fecaca;background:linear-gradient(135deg,#fff1f2,#fff);border-radius:16px;display:flex;align-items:center;justify-content:space-between;gap:12px}
      ...
      .v54-field label{display:block;font-size:12px;font-weight:900;color:#475569;margin:0 0 5px}
      .v54-field input,.v54-field select{width:100%;height:50px;border:1.5px solid #d7dee8;border-radius:14px;padding:0 14px;font:inherit;outline:none;background:#fff;color:#0f172a;font-weight:800}
      .v54-field input::placeholder{color:#94a3b8;font-weight:700}
      .v54-field input:focus,.v54-field select:focus{border-color:#ef4444;box-shadow:0 0 0 5px rgba(239,68,68,.12)}
