...
<style>@page{size:A4;margin:0}*{box-sizing:border-box;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}body{margin:0;background:#f1f5f9;font-family:Sarabun,sans-serif;color:#0f172a}.page{width:210mm;min-height:297mm;margin:0 auto;background:#fff;padding:12mm 14mm;display:flex;flex-direction:column}.top{display:flex;justify-content:space-between;align-items:flex-start;gap:18px;border-bottom:4px solid #0f766e;padding-bottom:12px}.shop{flex:1;min-width:0}.shop h1{margin:0;font-size:22px;font-weight:900;line-height:1.05}.shop p{margin:4px 0 0;color:#64748b;font-size:11px;line-height:1.45;max-width:420px}.doc{text-align:right;width:250px;flex:0 0 250px}.doc h2{margin:0 0 2px auto;background:#0f766e;color:#fff;border-radius:8px;padding:9px 16px;font-size:20px;line-height:1.2;display:inline-block;min-width:220px;text-align:center}.doc small{display:block;margin-top:6px;color:#64748b;font-size:11px;font-weight:900;line-height:1.25}.status{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:10px 0 9px}.status>div{border:0;background:transparent;border-left:3px solid #14b8a6;border-radius:0;padding:2px 0 2px 9px}.status span{display:block;color:#0f766e;font-size:9.5px;font-weight:900;line-height:1.15}.status b{display:block;margin-top:2px;font-size:12px;line-height:1.25}.notice{display:none}.grid{display:grid;grid-template-columns:1fr 1fr;gap:0 18px;margin:0 0 9px;border-top:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0}.box{border:0;border-radius:0;padding:7px 0;display:grid;grid-template-columns:82px minmax(0,1fr);gap:10px;align-items:baseline}.box span{display:block;font-size:9.5px;color:#64748b;font-weight:900}.box b{display:block;margin:0;font-size:12px;line-height:1.25}table{width:100%;border-collapse:collapse;margin-top:6px}th{background:#334155;color:#fff;padding:6px 8px;font-size:10.5px;text-align:left}td{border-bottom:1px solid #e5e7eb;padding:7px 8px;font-size:11px}tr:nth-child(even) td{background:#f8fafc}.c{text-align:center}.r{text-align:right}.b{font-weight:900}.summary{margin-left:auto;margin-top:9px;width:235px;border:1px solid #99f6e4;border-radius:8px;overflow:hidden}.summary div{display:flex;justify-content:space-between;align-items:center;padding:8px 10px;background:#f0fdfa;font-size:11px;font-weight:850}.summary strong{font-size:18px;color:#0f766e}.sign{margin-top:auto;display:flex;justify-content:center;gap:56px;padding-top:30px}.sig{text-align:center;min-width:180px;font-size:12px}.line{height:28px;border-bottom:1px solid #64748b;margin-bottom:5px}.foot{text-align:center;color:#94a3b8;border-top:1px solid #e2e8f0;margin-top:20px;padding-top:7px;font-size:9.5px}@media print{body{background:#fff}.page{margin:0}}</style></head><body><div class="page">
